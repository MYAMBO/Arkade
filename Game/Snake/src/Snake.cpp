...
void Snake::Eat()
{
    ...
    _objects["2/snake" + std::to_string(this->_snakeSize)]->setProperties(Arcade::IObject::SpriteProperties{{16, 16}, {6 * 16, 32}, {5, 5}, {0, 0}, {5, 5}, WHITE});
